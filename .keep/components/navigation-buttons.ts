...
export function NavigationButton(route: string, drawFunc: (ctx: HTMLElement, textHolder: HTMLElement) => VoidFunction) {
    ...
    let limiterCallback: VoidFunction = () => undefined
    function Stop(): void {
        limiterCallback();
    };
    function Play(): void {
        limiterCallback = drawFunc(canvas, title);
    };
